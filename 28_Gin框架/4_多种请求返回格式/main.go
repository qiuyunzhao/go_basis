...
func main() {
	...
	//请求静态资源 第1步
	egine.LoadHTMLGlob("28_Gin框架/html/*") //设置可加载HTML目录，要返回HTML类型需要先设置
	//请求静态资源 第2步
	egine.Static("/static", "28_Gin框架/static") //加载图片等静态资源要设置加载路径 relativePath:请求路由 root:项目静态资源路径
	//egine.StaticFS("/static",http.Dir("28_Gin框架/static")) //同上
	//egine.StaticFile("/static","28_Gin框架/static/赵敏.jpg") //请求单个静态文件
